...
def pregunta_03():
    ...
    pipeline = Pipeline(
    steps=[
        # Paso 1: Construye un column_transformer que aplica OneHotEncoder a las variables categóricas, y no aplica ninguna transformación al resto de las variables.
        (
            "column_transformer",
...
def pregunta_04():
    ...
    # Compute el error cuadratico medio de entrenamiento y prueba. Redondee los valores a dos decimales.
